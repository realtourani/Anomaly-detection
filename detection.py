...
cap = cv2.VideoCapture('videos/video1_with_anomalies.mp4')

coco_file = "config/obj.names"
coco_classes = []
net_config = "config/yolov3_training.cfg"
net_weights = "config/yolov3_training_final.weights"
blob_size = 320
